        ...
        <div className={`${profileToggle ? 'right-0 pointer-events-auto' : '-right-100 pointer-events-none'} profileToggle overflow-y-auto scrollbar-hide`}>
            ...
            <div className="content w-75 p-5 flex items-center gap-5 border-b">
                ...
                <div className='user-info space-y-2'>
                    ...
                    <NavLink className='bg-green-800 hover:bg-green-900 px-10 py-2 rounded-lg cursor-pointer duration-300 text-white' onClick={() => { setProfileToggle(false) }} to={'/profile'}>Update</NavLink>
                </div>
            </div>
            <ul className='p-5 space-y-5 text-xl'>
